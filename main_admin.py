...
"color: white")
        ...
        self.widget = QtWidgets.QWidget(parent=self.money_page)
        self.widget.setGeometry(QtCore.QRect(10, 680, 861, 37))
        self.widget.setObjectName("widget")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.pushButton_report = QtWidgets.QPushButton(parent=self.widget)
...
"}")
        ...
        self.frame_trouble.setGeometry(QtCore.QRect(0, 0, 881, 281))
        ...
        spacerItem2 = QtWidgets.QSpacerItem(528, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.frame_free_workers.setGeometry(QtCore.QRect(0, 10, 881, 271))
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/res/settings_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon2.addPixmap(QtGui.QPixmap(":/res/settings_24dp_005500_FILL0_wght400_GRAD0_opsz24.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.pushButton_settings1.setIcon(icon2)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 278, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
...
"}")
        ...
        self.pushButton_settings2.setIcon(icon2)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(20, 273, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
